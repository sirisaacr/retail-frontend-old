...
var OrdersService = (function () {
    ...
    OrdersService.prototype.addOrders = function () {
        ...
        var ordersToAdd = [];
        for (var _i = 0, _a = this.cart.source.value; _i < _a.length; _i++) {
            var order = _a[_i];
        ...
        this.http.post(this.baseUrl + "/addOrders", { cart_id: cart_id, ordersToAdd: ordersToAdd }, options)
            .map(function (response) { return response.json(); })
            .subscribe(function (data) {
            var tempStore = data.order;
            _this.ordersStore.orders.push(tempStore);
            _this._orders.next(Object.assign({}, _this.ordersStore).orders);
